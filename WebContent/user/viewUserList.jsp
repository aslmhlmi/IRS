						...
						<table id="basicTable" class="table table-striped table-bordered responsive">
							...
							<c:forEach items="${users}" var="user">
        						<tr>
        							...
        							<td><c:out value="${user.roleUser}" /></td>
            						<td><c:out value="${user.nameUser}" /></td>                                   
                					<td><c:out value="${user.emailUser}" /></td>
                					<td><c:out value="${user.telUser}" /></td>
                					<td><c:out value="${user.addressUser}" /></td>
                					<td><c:out value="${user.usernameUser}" /></td>
                    
                					<td><a href="UserController?action=user/viewUser&id=<c:out value="${user.userID}"/>"class="btn btn-warning btn-xs"> <i class="fa fa-info-circle"></i></a>             					
                					<a href="UserController?action=user/updateUser&id=<c:out value="${user.userID}"/>"class="btn btn-info btn-xs"> <i class="fa fa-edit"></i></a>
                					<a href="UserController?action=deleteUser&id=<c:out value="${user.userID}"/>"class="btn btn-danger btn-xs"> <i class="fa fa-trash-o"></i></a></td>
        						</tr>
        					</c:forEach>
						</table>
					</div>
