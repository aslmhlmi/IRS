						...
						<table id="basicTable" class="table table-striped table-bordered responsive">
							...
							<c:forEach items="${suppliers}" var="supplier">
        						<tr>
                					...
                					<td><a href="SupplierController?action=supplier/viewSupplier&id=<c:out value="${supplier.supplierID}"/>"class="btn btn-warning btn-xs"> <i class="fa fa-info-circle"></i> View</a>
                					<a href="SupplierController?action=deleteSupplier&id=<c:out value="${supplier.supplierID}"/>"class="btn btn-danger btn-xs"> <i class="fa fa-trash-o"></i> Remove</a>
                					<a href="SupplierController?action=supplier/updateSupplier&id=<c:out value="${supplier.supplierID}"/>" class="btn btn-info btn-xs"> <i class="fa fa-edit"></i> Update</a></td>
        						</tr>
        					</c:forEach>
						</table>
					</div>
