			...
			<ul class="nav nav-pills nav-stacked">
				...
				<li class="parent active"><a href="#"><i class="fa fa-truck"></i> <span>Supplier</span></a>
					<ul class="children">
						...
						<li class="active"><a href="/SIMS/SupplierController?action=createSupplier">Add New Supplier</a></li>
					</ul>
				</li>
		...
		<div class="mainpanel">
			...
			<div class="row">	
				...
				<div class="col-md-12">
								...
								<div class="row">
									<div class="col-sm-12">
										<div class="input-group mb15">
											...
											<input type="text" id="id" name="supplierID" class="form-control" placeholder="Enter supplier id" required="required" />
										</div>
									</div>
								</div>					
								<div class="row">
									<div class="col-sm-12">
										<div class="input-group mb15">
											<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
											<input type="text" id="name" name="nameSupplier" class="form-control" placeholder="Enter name" required="required" />
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-sm-6">
										<div class="input-group mb15">
											...
											<input type="text" id="email" name="emailSupplier" class="form-control" placeholder="Enter email" required="required">
										</div>
									</div>						
									<div class="col-sm-6">
										<div class="input-group mb15">
											<span class="input-group-addon"><i class="glyphicon glyphicon-earphone"></i></span>
											<input type="text" maxlength="11" id="tel" name="telSupplier" class="form-control" placeholder="Enter Phone Number (+06)" required="required">
										</div>
									</div>						
								</div>
								<div class="row">
									<div class="col-sm-12">
										<div class="input-group mb15">
											<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
											<input type="text" id="address" name="addressSupplier" class="form-control" placeholder="Enter address" required="required" />
										</div>
									</div>
								</div>		
					...
					<button type="submit" name="action" value="create" onclick="return confirm('Succesfully')">Submit</button>		
				</div>
