				...
				<div class="row">
					<div class="col-md-12">
						<table id="basicTable" class="table table-striped table-bordered responsive">
							<thead class="">
								<br/><a href="SupplierController?action=listSupplier">View Supplier List</a><br/><br><br>
								
								<p><b>Supplier ID :</b> <c:out value="${supplier.supplierID}" /></p>
								<p><b>Name :</b> <c:out value="${supplier.nameSupplier}" /></p>
								<p><b>Email :</b> <c:out value="${supplier.emailSupplier}" /></p>
								<p><b>Phone Number :</b> <c:out value="${supplier.telSupplier}" /></p>
								<p><b>Address :</b> <c:out value="${supplier.addressSupplier}" /></p>
