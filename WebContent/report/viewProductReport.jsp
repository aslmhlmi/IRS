	...
	<div class="mainwrapper">
		<div class="leftpanel">
			...
			<ul class="nav nav-pills nav-stacked">
				...
				<li class="parent"><a href="#"><i class="fa fa-truck"></i> <span>Supplier</span></a>
					<ul class="children">
						<li><a href="/SIMS/SupplierController?action=viewSupplierList">Manage Supplier</a></li>
				...
				<li class="active parent"><a href="#"><i class="fa fa-signal"></i> <span>Report</span></a>
					<ul class="children">
						<li class="active"><a href="/SIMS/report/viewProductReport.jsp">Product </a></li>
					</ul>
				</li>
		...
		<div class="mainpanel">
				...
				<div class="media">
					...
					<div class="media-body">
						<ul class="breadcrumb">
							...
							<li><a href="admin-list.jsp">Report</a></li>
			...
			<div class="contentpanel">
			  ...
			  <form id="generate-report" action="/SIMS/ProductController?action=report" method="get">
        <div class="row">
            <div class="col-lg-6">
                <div class="form-group">
                    <label>Start Date</label>

                    <div class="input-group date" id="dp_start_date" name="dp_start_date" style="max-width: 300px;">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group date" id="dp_end_date" name="dp_end_date" style="max-width: 300px;">
         ...
         <div class="row">
        <div class="col-lg-12">
            <button type="submit" class="btn btn-success" style="min-width:150px;" id="generate" name="action" value="report">Generate</button>
        </div>
        </div>
    </form>
