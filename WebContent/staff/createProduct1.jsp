	...
	<div class="mainwrapper">
		<div class="leftpanel">
			...
			<ul class="nav nav-pills nav-stacked">
				<li><a href="/SIMS/staff/indexS.jsp"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>
				...
				<li class="parent active"><a href="#"><i class="fa fa-shopping-cart"></i> <span>Product</span></a>
					<ul class="children"> 
						<li><a href="/SIMS/ProductController?action=staff/product/viewProductList1">Manage Product</a></li>
						<li class="active"><a href="/SIMS/ProductController?action=createProduct1">Add New Product</a></li>
					</ul>
				</li>				
					...
					<div class="media">
						...
						<div class="media-body">
							<ul class="breadcrumb">
								...
								<li><a href="/SIMS/indexS.jsp">Manage Product</a></li>
										...
										<div class="col-md-12">
											<div class="panel panel-default">
														...
														<div class="col-sm-6">
															<div class="input-group mb15">
																<span class="input-group-addon"></span> <select
																	name="supplierID" class="form-control" placeholder="Supplier name" required>
												...
												<div class="mt-3" align="center">
													<button type="submit" name="action" value="CreateBow">Submit</button>
												</div>
											</div>
											</div>
									</form>
									...
									<form name="form1" method="post" id="ff"
										...
										<div class="col-md-12">
											<div class="panel panel-default">
												...
												<div class="mt-3" align="center">
													<button type="submit" name="action" value="CreateArrow">Submit</button>
												</div>
											</div>
											</div>
									</form>
									...
									<form name="form1" method="post" id="ff"
										...
										<div class="col-md-12">
											<div class="panel panel-default">
												...
												<div class="mt-3" align="center">
													<button type="submit" name="action" value="CreateBoard">Submit</button>
												</div>
											</div>
											</div>
									</form>
