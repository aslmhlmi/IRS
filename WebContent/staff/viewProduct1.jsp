				...
				<div class="row">
					<div class="col-md-12">
						<table id="basicTable" class="table table-striped table-bordered responsive">
							<thead class="">
								<br/><a href="ProductController?action=listProduct">View Product List</a><br/><br><br>
								
								<p><b>Product ID :</b> <c:out value="${product.productID}" /></p>
								<p><b>Code :</b> <c:out value="${product.codeProduct}" /></p>
								<p><b>Name :</b> <c:out value="${product.nameProduct}" /></p>
								<p><b>Price :</b> <c:out value="${product.priceProduct}" /></p>
								<p><b>Total :</b> <c:out value="${product.totalProduct}" /></p>
								<p><b>Quantity :</b> <c:out value="${product.quantityProduct}" /></p>
